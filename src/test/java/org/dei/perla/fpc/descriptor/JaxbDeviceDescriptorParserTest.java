...
import org.dei.perla.channel.simulator.SimulatorChannelDescriptor;
import org.dei.perla.channel.simulator.SimulatorMessageDescriptor;
import org.dei.perla.channel.simulator.SimulatorIORequestDescriptor;
...
public class JaxbDeviceDescriptorParserTest {
	...
	private static final String descriptorPath = "src/test/java/org/dei/perla/fpc/descriptor/device_descriptor.xml";
	private List<String> packageList = Arrays
			.asList(new String[] { "org.dei.perla.fpc.descriptor",
