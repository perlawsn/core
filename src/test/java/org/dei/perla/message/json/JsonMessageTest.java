...
public class JsonMessageTest {
	...
	private static final Map<String, AttributeDescriptor> attributeMap = new HashMap<String, AttributeDescriptor>();
	...
	private static final String descriptor = "src/test/java/org/dei/perla/message/json/json_message_descriptor.xml";

	@BeforeClass
	public static void parseDeviceDescriptor() throws Exception {
		JAXBContext jc = JAXBContext
				.newInstance("org.dei.perla.fpc.descriptor"
						+ ":org.dei.perla.fpc.descriptor.instructions"
						+ ":org.dei.perla.message.json"
	...
	public void setFieldTest() {
		...
		env.setField("temperature", new Float(12));
	...
	public void setNonExistentField() {
		...
		env.setField("fake", new Integer(12));
	}
