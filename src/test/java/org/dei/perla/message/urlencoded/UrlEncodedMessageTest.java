...
public class UrlEncodedMessageTest {
	...
	private static final String descriptor = "src/test/java/org/dei/perla/message/urlencoded/urlencoded_message_descriptor.xml";
	...
	public static void parseDeviceDescriptor() throws Exception {
		JAXBContext jc = JAXBContext.newInstance("org.dei.perla.fpc.descriptor"
				...
				+ ":org.dei.perla.message.urlencoded"
	...
	public void unmarshalCorrect() {
		...
		assertThat((Float) message.getField("temperature"),
				equalTo(new Float(43)));
		assertThat((Float) message.getField("pressure"), equalTo(new Float(
				567)));
	}
