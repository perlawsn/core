...
public class HttpRequestBuilderFactoryTest {
	...
	private static final String descriptorPath =
            "src/test/java/org/dei/perla/core/channel/http/http_descriptor.xml";

	private static final String wrongDescriptorPath =
            "src/test/java/org/dei/perla/core/channel/http/wrong_http_descriptor.xml";
