...
public class JaxbDeviceDescriptorParserTest {
	...
	private static final String descriptorPath = "src/test/java/org/dei/perla/core/fpc/descriptor/device_descriptor.xml";
	private List<String> packageList = Arrays
			.asList(new String[] { "org.dei.perla.core.fpc.descriptor",
