...
import org.dei.perla.channel.IOTask;
import org.dei.perla.channel.Payload;
import org.dei.perla.channel.SynchronizerIOHandler;
import org.dei.perla.channel.simulator.GeneratorFieldDescriptor.GeneratorFieldQualifier;
...
public class SimulatorChannelTest {
	...
	private static final String descriptorPath = "src/test/java/org/dei/perla/channel/simulator/simulator_descriptor.xml";

	@BeforeClass
	public static void parseDeviceDescriptor() throws Exception {
		JAXBContext jc = JAXBContext.newInstance("org.dei.perla.fpc.descriptor"
	...
	public void parseSimulatorChannelTest() throws Exception {
		...
		for (GeneratorDescriptor generator : descriptor.getResponseList()) {
			...
			case "temp-only":
				...
				assertThat(field0.getQualifier(),
						equalTo(GeneratorFieldQualifier.STATIC));
				...
				assertThat(field1.getQualifier(),
						equalTo(GeneratorFieldQualifier.DYNAMIC));
			...
			case "all":
				...
				assertThat(field2.getQualifier(),
						equalTo(GeneratorFieldQualifier.DYNAMIC));
