...
import org.dei.perla.fpc.engine.ScriptParameter;
...
public class NativePeriodicOperation extends PeriodicOperation {
	...
	@Override
	protected void doStop(org.dei.perla.utils.StopHandler<Operation> handler) {
	...
	private void addAsyncCallback() {
		for (PeriodicMessageHandler asyncHandler : asyncHandlerList) {
			channelMgr.addCallback(asyncHandler.mapper,
					(FpcMessage msg) -> handleMessage(msg));
		}
	}
